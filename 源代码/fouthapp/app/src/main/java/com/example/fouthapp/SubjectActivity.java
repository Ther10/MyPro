...
import com.example.fouthapp.entity.MySubject;
import com.example.fouthapp.entity.SubjectRepertory;
                        ...
                        if(schedule.getName().equals("【广告】")){
                            ...
                            imageView.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    Toast.makeText(SubjectActivity.this,"进入广告网页链接",Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                    }
